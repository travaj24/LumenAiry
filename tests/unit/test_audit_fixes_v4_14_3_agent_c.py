...
class TestC1AngleUnsetSentinel:
...
class TestC1ApplyRotatorExplicitZeroAngleConflict:
...
class TestC1PolarizationFamilyConflictDetection:
...
class TestC1ConsistentAngleRadAndAngleDegAccepted:
...
class TestC2FreeformXYPolynomialNegativeNorm:
...
class TestC2FreeformChebyshevNegativeNorm:
...
class TestC3GhostElementsKeyPrescription:
...
class TestC4RegisterFixedGlassValidation:
