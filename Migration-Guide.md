...
[5.49.0 -- `transport='collins'` is the traced carrier chain's default](#5490----transportcollins-is-the-traced-carrier-chains-default)
...
## 5.49.0 -- `transport='collins'` is the traced carrier chain's default
