"""INDEPENDENT verification harness for Wave-5 hygiene 2 (verify/wave5-hygiene-2).

Written for this verification and not imported from the package under review;
the digest encoding deliberately matches ``probe_wave5_hyg2/hlib.py`` so keys
are comparable by eye, and the two were cross-checked on a shared fixture.
