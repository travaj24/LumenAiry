...
| `m6_staircase.py` | M6 -- z-staircase taper, per-slice grids vs the one-fine-lattice union: accuracy and cost |
...
python validation/probe_pmm2d_staggered_mortar/m3_nonconforming.py 4 5 6
...
python validation/probe_pmm2d_staggered_mortar/m6_staircase.py 4 5 6
