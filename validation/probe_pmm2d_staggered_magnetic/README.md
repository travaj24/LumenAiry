...
| `m5_closure_symmetry.py` | M5, M6 | G5 lossless closure with a Hermitian mu, the lossy-mu deficit, the tripwire predicate; G6 the x<->y transpose with the mu blocks swapped + the m12/m21 placement control |
