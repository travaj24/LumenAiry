...
| **D3** | one docstring paragraph at column 0 inside an indented docstring | indented; the same id's second arm reads `inspect.cleandoc` | **0 of 55** non-blank lines indented after cleandoc, against **53 of 55** on the PRE tree | identical |
