...
| **R3-5** (claims 1b / 6) | dated CORRECTED paragraphs for the round-2 numbers that did not reproduce | four corrections in `WP-B7c_ROUND2_REPORT.md`, one in `caustic_fold_truth.py` | **done** |
